...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		#if (haxe >= "4.0.0")
		inline bindKeys(Control.A0, [S]);
		inline bindKeys(Control.A1, [D]);
		inline bindKeys(Control.A2, [F]);
		inline bindKeys(Control.A3, [FlxKey.SPACE]);
		inline bindKeys(Control.A4, [J]);
		inline bindKeys(Control.A5, [K]);
		inline bindKeys(Control.A6, [L]);
