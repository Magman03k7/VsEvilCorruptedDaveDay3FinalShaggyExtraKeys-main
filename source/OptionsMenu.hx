			...
			if (controls.ACCEPT)
			{
				...
				switch(curSelected)
				{
					...
					case 7:
						...
						grpControls.add(ctrl);
					case 8:
						FlxG.save.data.makefair = !FlxG.save.data.makefair;
						var ctrl:Alphabet = new Alphabet(0, (70 * curSelected) + 30, "GT Force Off " + (FlxG.save.data.makefair ? "disable" : "enable"), true, false);
						ctrl.isMenuItem = true;
					...
					case 10:
						...
						grpControls.add(ctrl);
					case 11:
						if (Main.debugOpponentSide) {
							FlxG.save.data.opponentside = !FlxG.save.data.opponentside;
							var ctrl:Alphabet = new Alphabet(0, (70 * curSelected) + 30, "Opponent Side " + (!FlxG.save.data.opponentside ? "off" : "on"), true, false);
							ctrl.isMenuItem = true;
